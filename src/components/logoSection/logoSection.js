        ...
        <div className="logo-section-container">
            ...
            <div className="logo-container">
                <div className="logo-item">
                    ...
                    <p className="logo-description" > Juxy: Um design minimalista, porém único, que transmite uma identidade visual fora do convencional. A raposa, é um símbolo de inovação e criatividade. Já o círculo representa um universo de possibilidades infinitas, trazendo autenticidade. </p>
                </div>
                <div className="logo-item">
