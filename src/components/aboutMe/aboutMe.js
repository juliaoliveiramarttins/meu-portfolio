            ...
            <div className="about-me-inner">
                ...
                <div className="about-me-text">
                    ...
                    <p>
                        ...
                        <p>
                            Atualmente, sou estagiária em uma pequena empresa, onde auxilio nas operações diárias, como a <strong>manutenção de dados no banco de dados 
                                MySQL</strong> e a <strong>criação de Dashboards no Power BI</strong>. 
                        </p>
                        <p>
